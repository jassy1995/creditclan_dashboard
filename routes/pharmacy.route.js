...
router.post("/api/get-pharmacy-comment", Controller.getAllPharmacyComment);
...
router.post("/api/pharmacy/get-current-request", Controller.getInitialValue);
...
router.post("/api/get-pharmacy-per-step", Controller.SearchByStep);
